        ...
        <div className="relative overflow-hidden z-1 rounded-lg bg-[#D0E9F3] p-4 sm:p-7.5 lg:p-10 xl:p-15">
          <div className="max-w-[422px] w-full">
            ...
            <h2 className="font-bold text-dark text-xl lg:text-heading-4 xl:text-heading-3 mb-3">
              iPhone 15 Pro — Oferta Flash
            </h2>

            <p>Chip A17 Pro, titanio y cámara de 48 MP. Stock limitado. Garantía 12 meses.</p>
            ...
            >
              ...
              <div>
                <span
                  className="min-w-16 h-14.5 font-semibold text-xl lg:text-3xl text-dark rounded-lg flex items-center justify-center bg-white shadow-2 px-4 mb-2"
                  x-text="seconds"
                >
